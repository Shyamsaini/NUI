...
import { PrisonComponent } from '../_components/prison/prison.component';
...
export class ChitrakhoziComponent implements OnInit {
  ...
  constructor(
    private chitrakhoziService: ChitrakhoziService,  private dynamicModelService: DynamicModalService,
 ...
 openPrisonerComponent(data: string) {
    this.dynamicModelService.open(PrisonComponent, data);
  }
